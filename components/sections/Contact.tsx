...
import { Github, Linkedin, Twitter, Mail, Phone, MapPin, Send, MessageCircle } from "lucide-react"
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
          <div className="space-y-8">
            <div className="bg-white/50 dark:bg-gray-900/50 p-8 rounded-2xl border border-gray-200/50 dark:border-gray-700/50 shadow-lg">
              ...
              <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700">
                ...
                <div className="flex gap-3">
                  <a href="https://github.com/Sumayea104" target="_blank" className="p-3 bg-gray-100 dark:bg-gray-800 rounded-xl hover:bg-purple-100 transition hover:scale-110">
                    <Github size={20} />
                  </a>
                  <a href="https://www.linkedin.com/in/sumayea-rahman" target="_blank" className="p-3 bg-gray-100 dark:bg-gray-800 rounded-xl hover:bg-purple-100 transition hover:scale-110">
                    <Linkedin size={20} />
                  </a>
                  <a href="https://x.com/RahmanSuma22098" target="_blank" className="p-3 bg-gray-100 dark:bg-gray-800 rounded-xl hover:bg-purple-100 transition hover:scale-110">
                    <Twitter size={20} />
                  </a>
                  <a href="mailto:sumayearahman7@gmail.com" className="p-3 bg-gray-100 dark:bg-gray-800 rounded-xl hover:bg-purple-100 transition hover:scale-110">
                    <Mail size={20} />
                  </a>
                </div>
              </div>
